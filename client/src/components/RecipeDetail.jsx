        ...
        <div className="details-grid" key={id}>
            <div className="details-container">
                <div className="detail-container">
                    <img className="detail-img" src={myRecipe.img} alt="img not found" width="400px" height="500px"/>
                    <div className="info-aside">
                        <div className="title-container">
                            <h1 className="detail-title">{myRecipe.title}</h1>
                            <h3 className="detail-healthScore">{myRecipe.healthScore}</h3>
                        </div>
                                ...
                                <div className="border"></div>
                                    {
                                        ...
                                        myRecipe.dietTypes?.map((e) => (
                                            <div className="diets-h5-container" key={e}>
                                                <h3 className="diets-h5" key={e}>{e}</h3>
                                            </div>
                                        ))
                        ...
                        <div className="summary-container">
                            ...
                            <div className="border"></div>
                            <p className="detail-summary-p"><div dangerouslySetInnerHTML={{ __html: myRecipe.summary }}/></p>
                            <div className="border"></div>
                        </div>
                    </div>
                </div>
